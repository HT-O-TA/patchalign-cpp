"""CPU-only preflight for Data-v2 exploratory formal inference."""
...
def main() -> None:
    ...
    require(
        ...
        "exploratory inference preflight requires a clean worktree",
    )
    ...
    require(not args.output_dir.exists(), f"exploratory inference output already exists: {args.output_dir}")
    ...
    report = {
        "version": "data-v2-exploratory-formal-inference-preflight-v0.1",
        "status": "passed",
        "checked_at": utc_now(),
        "git_commit": commit,
