...
| RunBugRun data v0.0.1；匹配器语义固定到 legacy commit `5c023d6273ced705a5f83063b6b4cbf67aa81fa5` | A1/A2 C++ 数据与测试判定 | CodeNet 来源许可仍须逐项审计 | 原始代码、测试、候选池和 holdout 仅保留在集群数据目录，不进入 Git；仓库仅保存独立实现的兼容匹配语义及来源 revision |
