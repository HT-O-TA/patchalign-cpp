...
状态：正式数据与 preflight 已冻结；Job 94338 正在使用 1 张 A800 执行 M0 基线推理，正式训练与 M1 已按 afterok 排队。
...
- 当前链：M0 94338 → M0 评分 94339 与正式 SFT 94340 → M1 94341 → M1 评分 94342 → 比较 94343。三个 GPU 阶段串行且每个只申请 1 张 GPU。
...
| 阶段 | Job | 资源 | 依赖/初始状态 |
|---|---:|---|---|
| holdout 资格筛选 | 94174 | CPU 16 / 32 GiB / 12 h | RUNNING；首批检查点已落盘 |
| SFT 构建、冻结、preflight | 94175 | CPU 8 / 32 GiB / 4 h | afterok:94174 |
| M0 推理 / M0 评分 | 94176 / 94177 | GPU 1 / CPU | 94175 / 94176 |
| 正式 SFT | 94178 | GPU 1 | 94176 |
| M1 推理 / M1 评分 | 94179 / 94180 | GPU 1 / CPU | 94178 / 94179 |
| 质量门比较 | 94181 | CPU | 94177 与 94180 |

三个 GPU 作业严格串行，任意时刻最多占用本项目 1 张 GPU。
