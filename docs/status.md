...
最后核验：2026-09-07；exploratory replay formal 500 推理完成，CPU 真实评分已冻结待运行
...
| Data-v2 exploratory replay | formal 500 推理完成；评分绑定已冻结 | Job `96662` 完成 500/500，498 strict diff、3/3 probe 稳定；CPU scoring v2 待执行，尚无 Pass 结果 |
