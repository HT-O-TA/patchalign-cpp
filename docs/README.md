...
- 当前推荐交付模型：[M1-R2 模型卡](delivery/model_card_m1_r2.md)
- DPO 实验候选：[beta=0.3 候选模型卡](delivery/model_card_dpo_beta03.md)
...
- 历史收尾决策：[ADR-0009：曾以 SFT 与探索性研究作为交付终点](decisions/0009-close-after-sft-and-exploratory-a4.md)
...
- 宽泛来源停止线：[ADR-0028：关闭 BeetleBox 并结束宽泛搜索](decisions/0028-close-beetlebox-and-end-broad-source-search.md)
...
- DPO 选择口径：[ADR-0032：DPO 选择契约修正](decisions/0032-dpo-selection-contract-correction.md)
- DPO 最终候选：[ADR-0033：选择 beta=0.3 进入最终评测](decisions/0033-select-dpo-beta03-for-final-evaluation.md)
